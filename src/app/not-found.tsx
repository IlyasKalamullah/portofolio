  ...
  return (
    <div className="grid min-h-screen place-items-center bg-ink px-5 text-center">
      <div>
        ...
        <Link href="/" className="mt-6 inline-block rounded-full bg-white px-5 py-2 text-sm font-semibold text-ink hover:bg-accent hover:text-black">Kembali ke beranda</Link>
      </div>
    </div>
  );
}
